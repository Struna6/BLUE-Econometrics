...
//    }
//    
//    static func createModelFromFile(withHeaders : Bool, observationLabeled : Bool) -> Model{
//        readFromTxt()
...
//            i=i+1
//        }
//        return Model(header: headers, k: seperatedValues.count, n: i, observations: observations, withHeaders: withHeaders, observationLabeled: observationLabeled)
//    }
//}
